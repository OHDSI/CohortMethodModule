...
rCode <- c(rCode, "library(CohortMethod)")
rCode <- ParallelLogger::createArgFunction(functionName = 'runCmAnalyses',
...
OhdsiRTools::createRenvLockFile(rootPackage = "CohortMethod",
